...
def main():
  ...
  plistpath = scriptpath + "/resources/DuckyQ-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DuckyQ-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DuckyQ-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DuckyQ-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DuckyQ-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DuckyQ.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DuckyQ.iss",inplace=1):
