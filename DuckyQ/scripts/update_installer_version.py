...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DuckyQ Demo Installer\n"
      else:
        line="OutputBaseFilename=DuckyQ Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DuckyQ Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DuckyQ installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DuckyQ Demo installer\n"
     else:
       line="SetupWindowTitle=DuckyQ installer\n"
