...
def main():
  ...
  plistpath = scriptpath + "/resources/FrequentDuck-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FrequentDuck-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FrequentDuck-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FrequentDuck-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FrequentDuck-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FrequentDuck.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FrequentDuck.iss",inplace=1):
