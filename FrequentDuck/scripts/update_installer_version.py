...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FrequentDuck Demo Installer\n"
      else:
        line="OutputBaseFilename=FrequentDuck Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FrequentDuck Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FrequentDuck installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FrequentDuck Demo installer\n"
     else:
       line="SetupWindowTitle=FrequentDuck installer\n"
